...
SIZE = 1024
img = Image.new("RGBA", (SIZE, SIZE), (255, 109, 0, 255))  # naranja solido
...
draw.ellipse([s(74), s(61), s(86), s(74)], fill=(255, 109, 0, 255))
# Rear wheel
draw.ellipse([s(8), s(55), s(32), s(80)], fill="white")
draw.ellipse([s(14), s(61), s(26), s(74)], fill=(255, 109, 0, 255))
# Exhaust
draw.rectangle([s(10), s(58), s(28), s(62)], fill="white")
# Fork
draw.line([(s(78), s(50)), (s(80), s(62))], fill="white", width=s(4))

img.save("assets/images/moto_icon_full.png")
print("OK: assets/images/moto_icon_full.png generado")
