...
La app ya corre en iPhones físicos usando la cuenta gratuita ("Personal Team"), pero **no hay forma de compartir un link de descarga** — cada iPhone tiene que conectarse por cable a la Mac para instalar/actualizar la app. Pasos completos y solución de problemas: [`manual_ios.md`](manual_ios.md).
